        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          <div className="bg-primary/5 rounded-xl p-5 flex items-center justify-between">
            ...
            <div className="text-right flex items-center gap-3">
              <button onClick={() => router.push(`/dashboard/live-class?roomId=${upcoming.appointmentId || upcoming.id}`)} className="flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium text-sm transition">
